#ifndef _AUCTIONITEMFACTORY_H_
#define _AUCTIONITEMFACTORY_H_
 ...
 */
class AuctionItemFactory: public bb::cascades::ListItemProvider
{
public:
    AuctionItemFactory();
...
#endif // ifndef _AUCTIONITEMFACTORY_H_
