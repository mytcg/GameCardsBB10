#ifndef _AUCTIONITEM_H_
#define _AUCTIONITEM_H_
...
class AuctionItem: public bb::cascades::CustomControl, public ListItemListener
{
    Q_OBJECT

public:
    AuctionItem(Container *parent = 0);
