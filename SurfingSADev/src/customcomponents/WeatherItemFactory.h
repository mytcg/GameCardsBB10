#ifndef _WEATHERITEMFACTORY_H_
#define _WEATHERITEMFACTORY_H_
 ...
 */
class WeatherItemFactory: public bb::cascades::ListItemProvider
{
public:
	WeatherItemFactory();
...
#endif // ifndef _WEATHERITEMFACTORY_H_
